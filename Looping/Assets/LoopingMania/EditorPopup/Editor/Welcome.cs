...
namespace AppAdvisory.LoopMania
{
	...
	public class Welcome : EditorWindow 
	{
		...
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		private const string ONLINE_DOC_URL = "https://docs.google.com/document/d/1T62kgggc4_YexnEsRIVpCSUM4WGyPYnLTfp9b1nhl2M/edit?usp=sharing";
		private const string RATEUS_URL = "http://u3d.as/tgs";

		private const string NAME_OF_THE_GAME = "Looping Mania";
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
